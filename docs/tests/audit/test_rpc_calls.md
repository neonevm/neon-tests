...
| TestRpcCalls::test_eth_gas_price                                                    | Get eth gas price                                                               |           |
| TestRpcCalls::test_neon_gas_price_negative                                          | Get neon gas price, negative cases                                              |           |
| TestRpcCalls::test_neon_gas_price                                                   | Get neon gas price                                                              |           |
