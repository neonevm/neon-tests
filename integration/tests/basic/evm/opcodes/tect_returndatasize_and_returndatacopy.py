...
EXPECTED_RESULTS_STATIC = [
    ("makeRevert()", "Revert msg"),
...
class TestReturnDataSizeAndCopyOpcodes:
    ...
    @pytest.mark.parametrize(
        "position, size, expected_result", [(0, 64, DATA_0_64), (0, 96, DATA_0_96), (32, 64, DATA_32_64)]
    )
