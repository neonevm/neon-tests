...
class TestMultipleScheduledTrx:
    ...
    def test_2_depended_transactions(
        ...
        tree_account = evm_loader.create_tree_account_multiple(
            neon_user_for_evm_test, treasury_pool, tree_acc_data.data
        )
        additional_accounts = [
        ...
        assert neon_api_client.get_transaction_tree(neon_user_for_evm_test.neon_address.hex(), nonce).transactions == []
    ...
    def test_2_depended_transactions_one_failed(
        ...
        tree_account_data = neon_api_client.get_transaction_tree(neon_user_for_evm_test.neon_address.hex(), nonce)
    ...
    def test_deploy_and_call_contract(
        ...
        caller_contract: Contract = create_contract_address(neon_user_for_evm_test.neon_address, evm_loader)
    ...
    def test_call_precompiled_by_scheduled_trx(
        ...
        evm_loader.finish_scheduled_trx(operator_keypair, tree_account, holder_acc)
        assert neon_api_client.get_transaction_tree(
            neon_user_for_evm_test.neon_address.hex(), nonce
        ).all_transactions_successful()
        evm_loader.destroy_tree_account(neon_user_for_evm_test, treasury_pool, tree_account)
        assert neon_api_client.get_transaction_tree(neon_user_for_evm_test.neon_address.hex(), nonce).transactions == []
