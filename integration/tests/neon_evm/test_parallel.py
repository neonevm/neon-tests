...
from .solana_utils import EvmLoader, solana_client, make_new_user, deposit_neon, \
...
from .types.types import Caller, TreasuryPool
...
class ParallelTransactionsTest(TestCase):
    ...
    def create_same_accounts_subtest(self, iterations: int):
        ...
        deployment_tx = make_deployment_transaction(self.user_account, "big_contract", "BigContract")
        ...
        try:
            ...
            ParallelTransactionsTest.check_account_initialized_in_another_trx_exception(e,
                                                                                        contract.balance_account_address)
