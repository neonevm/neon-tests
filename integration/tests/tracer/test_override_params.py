...
class TestTracerOverrideParams:
    ...
    def test_stateOverrides_debug_traceCall_override_balance_both_accounts(self, storage_contract):
        ...
        override_params = {
            "stateOverrides": {
                address_from: {"balance": "0xd8d726b7177a80001"},
        ...
        assert (
            response_prestate_overrided["result"][address_from]["balance"]
            != response_prestate["result"][address_from]["balance"]
        )
        assert response_prestate_overrided["result"][address_from]["balance"] == "0xd8d726b7177a80001"
        assert (
            response_prestate_overrided["result"][address_to]["balance"]
            != response_prestate["result"][address_to]["balance"]
        )
    ...
    def test_stateOverrides_debug_traceCall_override_balance_invalid_format(self, call_storage_tx):
        ...
        override_params = {
            "stateOverrides": {
                address_from: {"balance": "0x25bf6196bd1"},
    ...
    def test_stateOverrides_debug_traceCall_override_code_of_contract_and_external_accounts(
        self, call_storage_tx, code
    ):
        address_from = call_storage_tx["from"].lower()
        address_to = call_storage_tx["to"].lower()
        params = self.fill_params_for_storage_contract_trace_call(call_storage_tx)
        ...
        override_params = {"stateOverrides": {address_from: {"code": code[0]}, address_to: {"code": code[1]}}}
        params.append(override_params)
        response_overrided = self.tracer_api.send_rpc("debug_traceCall", params)
        ...
        assert (
            response_prestate_overrided["result"][address_to]["code"] != response_prestate["result"][address_to]["code"]
        )
    ...
    def test_stateOverrides_debug_traceCall_override_state(self, storage_object):
        ...
        params_prestate[2]["stateOverrides"] = {
            address_to: {
                "code": response_prestate["result"][address_to]["code"],
        ...
        assert (
            response_prestate["result"][address_to]["storage"][index_0]
    ...
    def test_stateOverrides_debug_traceCall_override_state_invalid_index(self, call_storage_tx):
        ...
        params[2]["stateOverrides"] = {
            address_to: {"code": response["result"][address_to]["code"], "state": {"index": "0x863"}}
        }
        response_overrided = self.tracer_api.send_rpc("debug_traceCall", params)
    ...
    def test_stateOverrides_debug_traceCall_override_stateDiff_one_index(self, call_storage_tx):
        ...
        params_prestate[2]["stateOverrides"] = {
            address_to: {"stateDiff": {index_0: padhex(hex(self.storage_value + 1), 64)}}
        }
        response_overrided_prestate = self.tracer_api.send_rpc("debug_traceCall", params_prestate)
        ...
        assert "error" not in response_prestate, "Error in response"
        assert "error" not in response_overrided_prestate, "Error in response"
        assert response_overrided_prestate["result"][address_to]["storage"][index_0] == padhex(
            hex(self.storage_value + 1), 64
        )
    ...
    def test_stateOverrides_debug_traceCall_override_stateDiff_two_indexes(self, call_sum_of_values_tx):
        ...
        params_prestate[2]["stateOverrides"] = {
            address_to: {"stateDiff": {index_0: padhex(hex(101), 64), index_1: padhex(hex(103), 64)}}
        }
    ...
    def test_stateOverrides_debug_traceCall_override_stateDiff_add_non_existent_index_and_existed_one(
        self, call_sum_of_values_tx
    ):
        address_to = call_sum_of_values_tx["to"].lower()
        params = self.fill_params_for_storage_contract_trace_call(call_sum_of_values_tx)
        params_prestate = self.fill_params_for_storage_contract_trace_call(call_sum_of_values_tx, is_prestate=True)
        ...
        params_prestate[2]["stateOverrides"] = {
            address_to: {"stateDiff": {index_0: padhex(hex(101), 64), index_5: padhex("0x12", 64)}}
        }
        response_overrided_prestate = self.tracer_api.send_rpc("debug_traceCall", params_prestate)
        ...
        assert response_overrided_prestate["result"][address_to]["storage"][index_0] == padhex(hex(101), 64)
        assert (
            response_overrided_prestate["result"][address_to]["storage"][index_1]
            == response_prestate["result"][address_to]["storage"][index_1]
        )
        assert index_5 not in response_overrided_prestate["result"][address_to]["storage"]
    ...
    def test_stateOverrides_debug_traceCall_override_all_params_with_stateDiff(self, call_storage_tx):
        ...
        # code
        assert (
            response_overrided_prestate["result"][address_to]["code"] != response_prestate["result"][address_to]["code"]
        )
        assert response_overrided_prestate["result"][address_to]["code"] == CODE_OVERRIDED
        # nonce
        assert (
            response_overrided_prestate["result"][address_to]["nonce"]
            != response_prestate["result"][address_to]["nonce"]
        )
        assert response_overrided_prestate["result"][address_to]["nonce"] == 5
        # balance
        assert (
            response_overrided_prestate["result"][address_to]["balance"]
            != response_prestate["result"][address_to]["balance"]
        )
    ...
    def test_stateOverrides_debug_traceCall_override_with_state_and_stateDiff(self, call_store_value_tx):
        ...
        override_params = {
            "stateOverrides": {address_to: {"stateDiff": {"0x3": "0x11"}, "state": {"0x0": "0x15"}}},
            "tracer": "prestateTracer",
        }
        params.append(override_params)
        response_overrided = self.tracer_api.send_rpc("debug_traceCall", params)
    ...
    def test_blockOverrides_debug_traceCall_override_block(self, retrieve_block_tx, call_storage_tx):
        ...
        diff_storage = {
            "new_value": padhex(hex(call_storage_tx["blockNumber"]), 64)[2:],
            "old_value": padhex(hex(retrieve_block_tx["blockNumber"]), 64)[2:],
        }
        diff_block = {
            "new_value": hex(call_storage_tx["blockNumber"]),
    ...
    def test_blockOverrides_debug_traceCall_wrong_override_format(self, retrieve_block_tx, call_storage_tx):
        ...
        override_params = {
            "blockOverrides": {retrieve_block_tx["to"].lower(): {"number": call_storage_tx["blockNumber"]}}
        }
        params.append(override_params)
        response_overrided = self.tracer_api.send_rpc("debug_traceCall", params)
    ...
    def test_blockOverrides_debug_traceCall_override_block_timestamp(
        self, storage_contract, retrieve_block_timestamp_tx
    ):
        params_prestate = self.fill_params_for_storage_contract_trace_call(
            retrieve_block_timestamp_tx, is_prestate=True, is_tx_block=True
        )
        response_prestate = self.tracer_api.send_rpc_and_wait_response("debug_traceCall", params_prestate)
        ...
        params_new_prestate = self.fill_params_for_storage_contract_trace_call(
            retrieve_block_timestamp_tx_new, is_prestate=True, is_tx_block=True
        )
        ...
        diff_storage = {"new_value": padhex(hex(timestamp_new), 64)[2:], "old_value": padhex(hex(timestamp), 64)[2:]}
    ...
    def test_blockOverrides_debug_traceCall_override_block_timestamp_to_timestamp_now(
        self, retrieve_block_timestamp_tx
    ):
        params_prestate = self.fill_params_for_storage_contract_trace_call(
            retrieve_block_timestamp_tx, is_prestate=True, is_tx_block=True
        )
    ...
    def test_blockOverrides_debug_traceCall_override_block_number_and_timestamp(self, storage_object):
        ...
        params_1_prestate = self.fill_params_for_storage_contract_trace_call(
            block_info_tx_1, is_prestate=True, is_tx_block=True
        )
        ...
        params_2_prestate = self.fill_params_for_storage_contract_trace_call(
            block_info_tx_2, is_prestate=True, is_tx_block=True
        )
        ...
        diff_storage_block = {
            "new_value": padhex(hex(block_info_tx_2["blockNumber"]), 64)[2:],
            "old_value": padhex(hex(block_info_tx_1["blockNumber"]), 64)[2:],
        }
        diff_block = {
            "new_value": hex(block_info_tx_2["blockNumber"]),
            "old_value": hex(block_info_tx_1["blockNumber"]),
        }

        diff_storage_time = {
            "new_value": padhex(hex(timestamp_2), 64)[2:],
            "old_value": padhex(hex(timestamp_1), 64)[2:],
        }
        diff_time = {"new_value": hex(timestamp_2), "old_value": hex(timestamp_1)}
    ...
    def test_blockOverrides_and_stateOverrides_debug_traceCall(self, call_storage_tx, retrieve_block_tx):
        ...
        override_params = {
            "blockOverrides": {"number": call_storage_tx["blockNumber"]},
