...
tracer_data_producer = TracerLoadTestsDataProducer(
    web3_client, faucet, network_object["solana_url"], network_object["evm_loader"], "\3", BANK_ACCOUNT_PRIVATE_KEY
)
tracer_data_producer.prepare_tracer(
    transfers_number=TRANSFERS, contracts_calls_number=CONTRACT_CALLS, iterative_txs_number=ITERATIVE_TXS
)
