...
class NeonUser:
    ...
    def __init__(self, evm_loader_id, keypair=None):
        ...
        self.evm_loader = evm_loader_id if isinstance(evm_loader_id, Pubkey) else Pubkey.from_string(evm_loader_id)
    ...
    def get_balance_account(self, chain_id) -> Pubkey:
        ...
        return Pubkey.find_program_address([ACCOUNT_SEED_VERSION, self.neon_address, chain_id_bytes], self.evm_loader)[
            0
        ]
